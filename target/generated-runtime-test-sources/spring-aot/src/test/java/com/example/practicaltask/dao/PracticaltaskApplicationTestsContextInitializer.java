...
public final class PracticaltaskApplicationTestsContextInitializer {
  public static void registerProductDao(DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("productDao", ProductDao.class)
        .instanceSupplier((instanceContext) -> {
          ...
          public static void registerTransactionDao(DefaultListableBeanFactory beanFactory) {
            BeanDefinitionRegistrar.of("transactionDao", TransactionDao.class)
                .instanceSupplier((instanceContext) -> {
                          ...
                          instanceContext.field("userRepository", UserRepository.class)
                              .invoke(beanFactory, (attributes) -> {
                                ...
                                ReflectionUtils.setField(userRepositoryField, bean, attributes.get(0));
                                  ...
                                  public static void registerUserDao(
                                      DefaultListableBeanFactory beanFactory) {
                                    BeanDefinitionRegistrar.of("userDao", UserDao.class)
                                        .instanceSupplier((instanceContext) -> {
